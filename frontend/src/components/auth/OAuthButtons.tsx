...
export default function OAuthButtons({ mode = 'login' }: OAuthButtonsProps) {
  const { googleLogin, githubLogin, linkedinLogin, facebookLogin, loading } = useAuth();
    ...
    <div className="w-full mt-4 space-y-3">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        >
          ...
          <span>
            {loadingProvider === 'google' ? 'Loading...' : `Google`}
          </span>
        </button>
        ...
        >
          ...
          <span>
            {loadingProvider === 'github' ? 'Loading...' : `GitHub`}
          </span>
        </button>
        ...
        >
          ...
          <span>
            {loadingProvider === 'linkedin' ? 'Loading...' : `LinkedIn`}
          </span>
        </button>
        ...
        >
          ...
          <span>
            {loadingProvider === 'facebook' ? 'Loading...' : `Facebook`}
          </span>
        </button>
      </div>
    </div>
